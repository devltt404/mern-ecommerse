    ...
    <SkeletonWrapper isLoading={isLoading}>
      <div className="group transition bg-white hover:bg-black px-6 py-6 shadow-md  hover:scale-[1.03] hover:shadow-lg cursor-pointer relative">
        <div className="flex items-center gap-4 mb-6">
          <div className="inline-block p-3 bg-gray-100 rounded-full group-hover:bg-white">
            <Icon size={24} />
          </div>
        ...
        <div className="absolute transition opacity-100 right-4 bottom-6 group-hover:opacity-100 ">
